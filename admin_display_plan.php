...
<html>
	...
	<body>
		  <nav class="nav nav-pills flex-column flex-sm-row">
  				<a class="flex-sm-fill text-sm-center nav-link active" href="//Restaurant-Management-System/index.php">Home</a>
  				<a class="flex-sm-fill text-sm-center nav-link" href="/Restaurant-Management-System/admin_plan.html">Add Plan</a>
		  </nav>
        <div class="empty">
        </div>
        <h2> Plan Details </h2>
